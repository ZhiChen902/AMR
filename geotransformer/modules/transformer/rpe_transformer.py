...
class RPEMultiHeadAttention(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None, parsed_args=None):
...
class RPEAttentionLayer(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None, parsed_args=None):
        ...
        self.parsed_args = parsed_args
        self.attention = RPEMultiHeadAttention(d_model, num_heads, dropout=dropout, parsed_args=parsed_args)
...
class RPETransformerLayer(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None, activation_fn='ReLU',parsed_args=None):
        super(RPETransformerLayer, self).__init__()
        self.parsed_args = parsed_args
        self.attention = RPEAttentionLayer(d_model, num_heads, dropout=dropout,parsed_args=parsed_args)
